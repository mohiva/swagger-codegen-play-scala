package io.swagger.codegen.playscala;

import io.swagger.codegen.CodegenModel;
import io.swagger.codegen.CodegenProperty;
import io.swagger.codegen.DefaultCodegen;
import io.swagger.codegen.languages.PlayScalaClientCodegen;
...
public class PlayScalaModelTest {
    ...
    public void simpleModelTest() {
        final Model model = new ModelImpl()
                ...
                .required("id")
                .required("name");
        final DefaultCodegen codegen = new PlayScalaClientCodegen();
        ...
        Assert.assertEquals(property3.defaultValue, "None");
    ...
    public void listPropertyTest() {
        ...
        Assert.assertEquals(property1.defaultValue, "None");
